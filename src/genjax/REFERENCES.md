...
This document provides comprehensive references for the core GenJAX module,
including generative function interface (GFI) implementations, probability
distributions, and probabilistic JAX (PJAX) infrastructure.
...
**Conference**: Proceedings of the 40th ACM SIGPLAN Conference on Programming
Language Design and Implementation (PLDI), pp. 221-236 **DOI**:
10.1145/3314221.3314642 **Abstract**: Introduces Gen, a probabilistic
programming system with the Generative Function Interface enabling programmable
inference

**Used in**:

- `core.py:1030-1285` - Complete GFI implementation (simulate, assess, generate,
  update, regenerate)
...
**Publisher**: John Wiley & Sons, New York, 2nd edition **ISBN**: 0-471-54897-9
...
**Publisher**: John Wiley & Sons, New York, 2nd edition **ISBN**: 0-471-58495-9
...
**Publisher**: John Wiley & Sons, New York, 2nd edition **ISBN**: 0-471-58494-0
...
**Publisher**: CRC Press **ISBN**: 0-8247-5396-6 **Abstract**: Comprehensive
treatment of beta distribution theory and applications
...
**Publisher**: Springer, New York **ISBN**: 978-0-387-31073-2 **Abstract**:
Comprehensive textbook on machine learning with probabilistic foundations
...
**Publisher**: Marcel Dekker, 2nd edition **ISBN**: 0-8247-9342-0 **Abstract**:
Comprehensive reference on normal distribution
...
**Publisher**: John Wiley & Sons, New York **ISBN**: 978-0471333326
...
**Publisher**: Academic Press, London **ISBN**: 0-12-471250-9 **Abstract**:
Classic text on multivariate statistical analysis
...
**Publisher**: Springer-Verlag, New York **ISBN**: 0-387-97062-0 **Abstract**:
Comprehensive treatment of multivariate normal distribution
...
**Publisher**: John Wiley & Sons, New York, 2nd edition **ISBN**: 0-471-18387-3
...
**Publisher**: John Wiley & Sons **ISBN**: 978-0-470-68819-9 **Abstract**:
Modern comprehensive treatment of Dirichlet distribution
...
**Publisher**: Marcel Dekker, New York **ISBN**: 0-8247-7803-0 **Abstract**:
Comprehensive reference on log-normal distribution
...
**Journal**: BioScience, 51(5), 341-352 **DOI**:
10.1641/0006-3568(2001)051[0341:LNDATS]2.0.CO;2 **Abstract**: Review of
log-normal distribution applications across scientific disciplines
...
**Journal**: Journal of the American Statistical Association (JASA), 84(408),
881-896 **DOI**: 10.1080/01621459.1989.10478852 **Abstract**: Robust statistical
methods using Student's t distribution
...
**Publisher**: Cambridge University Press **ISBN**: 0-521-82654-3 **Abstract**:
Comprehensive treatment of multivariate t-distributions
...
**Documentation**: JAX official documentation **URL**:
...
**ArXiv**: arXiv:1809.10756 **Abstract**: Comprehensive introduction to
probabilistic programming concepts and systems
...
The GenJAX core module implements the Generative Function Interface (GFI) from
Gen.jl [1] in JAX, providing:

1. **Full GFI implementation** with all required methods (simulate, assess,
   generate, update, regenerate)
2. **Comprehensive distribution library** with proper citations to statistical
   literature
3. **PJAX infrastructure** for probabilistic JAX transformations
4. **State interpreter** for diagnostic and debugging support

All distributions follow the parameterizations specified in their respective
references, with adaptations for JAX's computational model and automatic
